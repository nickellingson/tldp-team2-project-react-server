...
const registrationController = {
    ...
    postRegistration: function(req, res) {
      Registration.create({ EVENT_ID: req.body.event_id, REGISTRATION_DATE: req.body.registration_date, CUSTOMER_ID: req.body.customer_id, NOTES: req.body.notes}).then(
        (c) => { 
          res.location(`/api/registration/${c.REGISTRATION_ID}`)
          res.sendStatus(201)
        }, // OK
